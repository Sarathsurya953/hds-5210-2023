...
**Overall, this was a great final project.  Great work!  I found it pretty easy to follow.  One of the things I like was when you would do analysis and THEN decide to turn into a function. I liked the honesty of your process and the lifecycle of your notebook.**

**(-1) Variable names `data_merge1` and `data_merge2` aren't descriptive of what the data is or why it is important.**